...
\begin{table}[ht]
 ...
 V=50k & Nematus  & 3393 & 284 & 17.28 \\
  ...
  \end{tabular}
  \label{tab:res}
  \caption{\small Performance Results for EN$\rightarrow$DE on WMT15 tested on newstest2014. Both system 2x500 RNN, embedding size 500, 13 epochs, batch size 64. We compare on a 50k vocabulary and a 32k BPE setting.}
\end{table}
...
We introduce \texit{OpenNMT}, a research toolkit for NMT is
