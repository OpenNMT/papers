...
\begin{table}[ht]
  ...
  \begin{tabular}{lccccc}
    \toprule
          & ES & FR & IT & PT & RO \\
    \midrule
ES	& - & \scriptsize 32.7 +5.4	 & \scriptsize 28.0 +4.6 & \scriptsize 34.4 +6.1 & \scriptsize 28.7 +6.4 \\ 
FR	& \scriptsize 32.9 +3.3	& -  & \scriptsize 26.3 +4.3	 & \scriptsize 30.9 +5.2 & \scriptsize 26.0 +6.6 \\
IT     & \scriptsize 31.6 +5.3	 & \scriptsize 31.0 +5.8 & - & \scriptsize 28.0 +5.0 & \scriptsize 24.3 +5.9 \\
PT	& \scriptsize 35.3 +10.4 & \scriptsize 34.1 +4.7 & \scriptsize 28.1 +5.6 & - & \scriptsize 28.7 +5.0\\
RO	& \scriptsize 35.0 +5.4 & \scriptsize 31.9 +9.0 & \scriptsize 26.4 +6.3 & \scriptsize 31.6 +7.3 & -\\
    \bottomrule
  \end{tabular}
  \label{tab:esfritptro}
  \caption{\small 20 language pair single translation model. Table shows BLEU $\Delta$ where $\Delta$ compares to only using that pair for training. }
\end{table}
...
providing a stable and extensible framework for production use.
