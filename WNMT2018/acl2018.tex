...
to preprocess the data \newcite{sennrich2015neural}. Hence, the generated
...
\newcite{vaswani2017attention}.  Unlike standard sequence-to-sequence
...
translation \newcite{DBLP:journals/corr/abs-1803-02155} Another advantage
...
Short-Term Memory hidden \newcite{Hochreiter:1997:LSM:1246443.1246450} units and attentional architecture. Full details of the
...
cell with GRU cells \newcite{DBLP:journals/corr/ChoMGBSB14}. Indeed LSTM
...
extends vocabulary mapping to multi-word expressions\footnote{For
  ...
  translated by {\tt à nouveau} will need the 2 additional meanings {\tt à} and {\tt nouveau} not
