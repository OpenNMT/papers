...
1-gram approach (saturating the Test Coverage at 80\%).
...
model for CPU demonstrating again the powerful effect of the distillation process and for the first time cross-class. Most of the additional presented optimizations can apply for other architecture. Our final system does show a significant increase in speed of \textcolor{red}{110x} over the baseline and demonstrate a throughput of 1000 word/s on a single core which is the fastest reported so far...
