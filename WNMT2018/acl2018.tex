...
\title{OpenNMT Fast-CPU System Description for WNMT 2018}
...
The final model reaches 1000 words/sec on the evaluation CPU hardware and is the fastest CPU model submitted.
