...
We use 16-bit int quantization method proposed in \newcite{DBLP:journals/corr/Devlin17} - however to better optimize speed on AWS M5 instance powered with Intel Skylake CPU - we extended the proposed approach to SIMD AVX512 instruction set. 
